...
object FiberRef {
  ...
  object unsafe {
    ...
    private[zio] final class FiberRef0[Value0, Patch0](
      ...
      override private[zio] val hasSecondFnJoin: Boolean = join0 eq ZIO.secondFn[Value0]
    }
    ...
    def makePatch[Value0, Patch0](
      ...
      new FiberRef0(initialValue0, differ, fork0, join0)
