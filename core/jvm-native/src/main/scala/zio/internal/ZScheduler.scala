...
private final class ZScheduler(autoBlocking: Boolean) extends Executor {
  ...
  private final class ZSchedulerSupervisor extends ZScheduler.Supervisor {
  ...
  private[this] def makeSupervisor(): ZScheduler.Supervisor = new ZSchedulerSupervisor

  private final class ZSchedulerWorker extends ZScheduler.Worker {
      self =>
  ...
  private[this] def makeWorker(): ZScheduler.Worker = new ZSchedulerWorker
