...
object TracerUtils {
   ...
   *
   * Implementation note:
   * It parses the string from the end to the beginning for performances reasons
   * See [[zio.internal.stacktracer.Tracer.createTrace]] for the format of the trace
   */
